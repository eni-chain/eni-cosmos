...
// If expedited, the deposit to enter voting period will be increased to 5000 ueni.
...
var (
	MinExpeditedDeposit   = sdk.NewCoins(sdk.NewCoin("ueni", types.DefaultMinExpeditedDepositTokens))
