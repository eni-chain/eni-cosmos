...
import (
	...
	"github.com/cosmos/cosmos-sdk/x/evm/artifacts/weni"
...
func GetTxCmd() *cobra.Command {
	...
	cmd.AddCommand(NewAddBlacklistsCmd())
	cmd.AddCommand(NewDelBlacklistsCmd())
	return cmd
}
...
func CmdAssociateAddress() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			txData := AssociateRequest{V: hex.EncodeToString(V.Bytes()), R: hex.EncodeToString(R.Bytes()), S: hex.EncodeToString(S.Bytes())}
