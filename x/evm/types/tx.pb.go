...
type MsgEVMTransaction struct {
	...
	Derived *github_com_eni_chain_go_eni_x_evm_derived.Derived `protobuf:"bytes,3,opt,name=derived,proto3,customtype=github.com/cosmos/cosmos-sdk/x/evm/derived.Derived" json:"derived,omitempty"`
}
