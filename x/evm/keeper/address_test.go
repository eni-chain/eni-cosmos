...
//	require.Nil(t, a.BankKeeper.MintCoins(ctx, "evm", sdk.NewCoins(sdk.NewCoin("ENI", sdk.NewInt(10)))))
//	require.Nil(t, a.BankKeeper.SendCoinsFromModuleToAccount(ctx, "evm", sourceAddr, sdk.NewCoins(sdk.NewCoin("ENI", sdk.NewInt(5)))))
//	amt := sdk.NewCoins(sdk.NewCoin("ENI", sdk.NewInt(1)))
