...
func NewBlobTx(tx *ethtypes.Transaction) (*BlobTx, error) {
	...
	bh := tx.BlobHashes()
	SetConvertIfPresent(&bh, func(hs *[]common.Hash) [][]byte { return Map(*hs, func(h common.Hash) []byte { return h[:] }) }, txData.SetBlobHashes)
...
func (tx *BlobTx) GetBlobHashes() []common.Hash {
	...
	return Map(tx.BlobHashes, func(hash []byte) common.Hash {
...
func sidecarConverter(ethSidecar *ethtypes.BlobTxSidecar) *BlobTxSidecar {
	...
	return &BlobTxSidecar{
		Blobs:       Map(ethSidecar.Blobs, func(b kzg4844.Blob) []byte { return b[:] }),
		Commitments: Map(ethSidecar.Commitments, func(c kzg4844.Commitment) []byte { return c[:] }),
		Proofs:      Map(ethSidecar.Proofs, func(p kzg4844.Proof) []byte { return p[:] }),
	}
}
...
func sidecarToEthSidecar(sidecar *BlobTxSidecar) *ethtypes.BlobTxSidecar {
	...
	return &ethtypes.BlobTxSidecar{
		Blobs:       Map(sidecar.Blobs, func(b []byte) kzg4844.Blob { return kzg4844.Blob(b) }),
		Commitments: Map(sidecar.Commitments, func(b []byte) kzg4844.Commitment { return kzg4844.Commitment(b) }),
		Proofs:      Map(sidecar.Proofs, func(p []byte) kzg4844.Proof { return kzg4844.Proof(p) }),
	}
}
