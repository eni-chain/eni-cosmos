...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
		...
		{"", nil, false},
		{"4ueni", sdk.DecCoins{sdk.NewDecCoinFromDec("ueni", sdk.NewDecFromInt(sdk.NewInt(4)))}, false},
		{"5.5atom,4ueni", sdk.DecCoins{
			sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
			sdk.NewDecCoinFromDec("ueni", sdk.NewDec(4)),
		}, false},
		{"0.0ueni", sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0atom,20.0btc", nil, true},
		{
			"0.004ueni",
			sdk.DecCoins{sdk.NewDecCoinFromDec("ueni", sdk.NewDecWithPrec(4000000000000000, sdk.Precision))},
			false,
		},
		{
			"0.004ueni",
		...
		},
		{
			...
			sdk.DecCoins{
				...
				sdk.NewDecCoinFromDec("ueni", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
		{"0.0ueni,0.004ueni,5.04atom", // remove zero coins
			sdk.DecCoins{
				sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5040000000000000000, sdk.Precision)),
				sdk.NewDecCoinFromDec("ueni", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
...
func (s *decCoinTestSuite) TestDecCoinsString() {
	testCases := []struct {
		...
		{sdk.DecCoins{}, ""},
		{
			...
			"5.040000000000000000atom,0.004000000000000000ueni",
		},
	}
...
func (s *decCoinTestSuite) TestDecCoinsIntersect() {
	testCases := []struct {
		...
		{"", "", ""},
		{"1.0ueni", "", ""},
		{"1.0ueni", "1.0ueni", "1.0ueni"},
		{"", "1.0ueni", ""},
		{"1.0ueni", "", ""},
		{"2.0ueni,1.0trope", "1.9ueni", "1.9ueni"},
		{"2.0ueni,1.0trope", "2.1ueni", "2.0ueni"},
		{"2.0ueni,1.0trope", "0.9trope", "0.9trope"},
		{"2.0ueni,1.0trope", "1.9ueni,0.9trope", "1.9ueni,0.9trope"},
		{"2.0ueni,1.0trope", "1.9ueni,0.9trope,20.0other", "1.9ueni,0.9trope"},
		{"2.0ueni,1.0trope", "1.0other", ""},
		{"2.0ueni,1.0trope", "0.9trope,20.0other,1.9ueni", "1.9ueni,0.9trope"},
	}
